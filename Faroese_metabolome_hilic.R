...
mapping_hilic <- read.delim("C:/Users/midyav01/OneDrive - The Mount Sinai Hospital/MSSM Projects/METABOLOMICS/New_faroese/HILIC/Perfluoroalkyl_ALL_mapping_hilicpos.txt")

# read median summarized HILIC+ table
median_sum_feature_hilic <- read.csv("C:/Users/midyav01/OneDrive - The Mount Sinai Hospital/MSSM Projects/METABOLOMICS/New_faroese/HILIC/MetabComBat_HILICpos_Merged_mediansummarized_featuretable_final.csv")
...
for(i in 1:nrow(median_sum_feature_hilic)){
  ...
  rrt <- stage4_hilic$KEGG.ID[which(abs(median_sum_feature_hilic$mz[i] - stage4_hilic$mz) < 5)]
...
length(unique(median_sum_feature_hilic$KEGG)) #110
...
# length(unique(median_sum_feature_hilic$KEGG)) #109
...
# write.csv(data_hilic, "C:/Users/midyav01/OneDrive - The Mount Sinai Hospital/MSSM Projects/METABOLOMICS/New_faroese/HILIC/data_hilic.csv", row.names = F)
