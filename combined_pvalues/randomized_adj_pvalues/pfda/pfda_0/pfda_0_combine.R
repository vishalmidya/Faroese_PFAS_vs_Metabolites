...
d1 <- fread("/sc/arion/projects/Faroese/pfas_met/hilic/pfda/pfda_0/minerva_data_pfda_0_metabolites_7/pfda_0_met_7_hypothetical_test_stat_hilic.txt")
d2 <- fread("/sc/arion/projects/Faroese/pfas_met/hilic/pfda/pfda_0/minerva_data_pfda_0_metabolites_14/pfda_0_met_14_hypothetical_test_stat_hilic.txt")
d3 <- fread("/sc/arion/projects/Faroese/pfas_met/hilic/pfda/pfda_0/minerva_data_pfda_0_metabolites_22/pfda_0_met_22_hypothetical_test_stat_hilic.txt")
d4 <- fread("/sc/arion/projects/Faroese/pfas_met/hilic/pfda/pfda_0/minerva_data_pfda_0_metabolites_28/pfda_0_met_28_hypothetical_test_stat_hilic.txt")

d5 <- fread("/sc/arion/projects/Faroese/pfas_met/c18/pfda/pfda_0/minerva_data_pfda_0_metabolites_7/pfda_0_met_7_hypothetical_test_stat_c18.txt") %>% select(all_of(c18_resultsid))
d6 <- fread("/sc/arion/projects/Faroese/pfas_met/c18/pfda/pfda_0/minerva_data_pfda_0_metabolites_14/pfda_0_met_14_hypothetical_test_stat_c18.txt") %>% select(all_of(c18_resultsid))
d7 <- fread("/sc/arion/projects/Faroese/pfas_met/c18/pfda/pfda_0/minerva_data_pfda_0_metabolites_22/pfda_0_met_22_hypothetical_test_stat_c18.txt") %>% select(all_of(c18_resultsid))
d8 <- fread("/sc/arion/projects/Faroese/pfas_met/c18/pfda/pfda_0/minerva_data_pfda_0_metabolites_28/pfda_0_met_28_hypothetical_test_stat_c18.txt") %>% select(all_of(c18_resultsid))

test_stat_table <- as.data.frame(cbind(d1,d2,d3,d4,d5,d6,d7,d8))


p1 <- fread("/sc/arion/projects/Faroese/pfas_met/hilic/pfda/pfda_0/minerva_data_pfda_0_metabolites_7/pfda_0_met_7_beta_fisher_hilic.txt")%>% filter(Met_id %in% hilic_metid)
p2 <- fread("/sc/arion/projects/Faroese/pfas_met/hilic/pfda/pfda_0/minerva_data_pfda_0_metabolites_14/pfda_0_met_14_beta_fisher_hilic.txt")%>% filter(Met_id %in% hilic_metid)
p3 <- fread("/sc/arion/projects/Faroese/pfas_met/hilic/pfda/pfda_0/minerva_data_pfda_0_metabolites_22/pfda_0_met_22_beta_fisher_hilic.txt")%>% filter(Met_id %in% hilic_metid)
p4 <- fread("/sc/arion/projects/Faroese/pfas_met/hilic/pfda/pfda_0/minerva_data_pfda_0_metabolites_28/pfda_0_met_28_beta_fisher_hilic.txt")%>% filter(Met_id %in% hilic_metid)

p5 <- fread("/sc/arion/projects/Faroese/pfas_met/c18/pfda/pfda_0/minerva_data_pfda_0_metabolites_7/pfda_0_met_7_beta_fisher_c18.txt") %>% filter(Met_id %in% c18_metid)
p6 <- fread("/sc/arion/projects/Faroese/pfas_met/c18/pfda/pfda_0/minerva_data_pfda_0_metabolites_14/pfda_0_met_14_beta_fisher_c18.txt") %>% filter(Met_id %in% c18_metid)
p7 <- fread("/sc/arion/projects/Faroese/pfas_met/c18/pfda/pfda_0/minerva_data_pfda_0_metabolites_22/pfda_0_met_22_beta_fisher_c18.txt") %>% filter(Met_id %in% c18_metid)
p8 <- fread("/sc/arion/projects/Faroese/pfas_met/c18/pfda/pfda_0/minerva_data_pfda_0_metabolites_28/pfda_0_met_28_beta_fisher_c18.txt") %>% filter(Met_id %in% c18_metid)
