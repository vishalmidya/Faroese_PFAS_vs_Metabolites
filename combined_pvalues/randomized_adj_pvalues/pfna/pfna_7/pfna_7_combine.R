...
d2 <- fread("/sc/arion/projects/Faroese/pfas_met/hilic/pfna/pfna_7/minerva_data_pfna_7_metabolites_14/pfna_7_met_14_hypothetical_test_stat_hilic.txt")%>% select(all_of(hilic_resultsid))
d3 <- fread("/sc/arion/projects/Faroese/pfas_met/hilic/pfna/pfna_7/minerva_data_pfna_7_metabolites_22/pfna_7_met_22_hypothetical_test_stat_hilic.txt")%>% select(all_of(hilic_resultsid))
d4 <- fread("/sc/arion/projects/Faroese/pfas_met/hilic/pfna/pfna_7/minerva_data_pfna_7_metabolites_28/pfna_7_met_28_hypothetical_test_stat_hilic.txt")%>% select(all_of(hilic_resultsid))

d6 <- fread("/sc/arion/projects/Faroese/pfas_met/c18/pfna/pfna_7/minerva_data_pfna_7_metabolites_14/pfna_7_met_14_hypothetical_test_stat_c18.txt") %>% select(all_of(c18_resultsid))
d7 <- fread("/sc/arion/projects/Faroese/pfas_met/c18/pfna/pfna_7/minerva_data_pfna_7_metabolites_22/pfna_7_met_22_hypothetical_test_stat_c18.txt") %>% select(all_of(c18_resultsid))
d8 <- fread("/sc/arion/projects/Faroese/pfas_met/c18/pfna/pfna_7/minerva_data_pfna_7_metabolites_28/pfna_7_met_28_hypothetical_test_stat_c18.txt") %>% select(all_of(c18_resultsid))

test_stat_table <- as.data.frame(cbind(d2,d3,d4, d6,d7,d8))


p2 <- fread("/sc/arion/projects/Faroese/pfas_met/hilic/pfna/pfna_7/minerva_data_pfna_7_metabolites_14/pfna_7_met_14_beta_fisher_hilic.txt")%>% filter(Met_id %in% hilic_metid)
p3 <- fread("/sc/arion/projects/Faroese/pfas_met/hilic/pfna/pfna_7/minerva_data_pfna_7_metabolites_22/pfna_7_met_22_beta_fisher_hilic.txt")%>% filter(Met_id %in% hilic_metid)
p4 <- fread("/sc/arion/projects/Faroese/pfas_met/hilic/pfna/pfna_7/minerva_data_pfna_7_metabolites_28/pfna_7_met_28_beta_fisher_hilic.txt")%>% filter(Met_id %in% hilic_metid)

p6 <- fread("/sc/arion/projects/Faroese/pfas_met/c18/pfna/pfna_7/minerva_data_pfna_7_metabolites_14/pfna_7_met_14_beta_fisher_c18.txt") %>% filter(Met_id %in% c18_metid)
p7 <- fread("/sc/arion/projects/Faroese/pfas_met/c18/pfna/pfna_7/minerva_data_pfna_7_metabolites_22/pfna_7_met_22_beta_fisher_c18.txt") %>% filter(Met_id %in% c18_metid)
p8 <- fread("/sc/arion/projects/Faroese/pfas_met/c18/pfna/pfna_7/minerva_data_pfna_7_metabolites_28/pfna_7_met_28_beta_fisher_c18.txt") %>% filter(Met_id %in% c18_metid)
