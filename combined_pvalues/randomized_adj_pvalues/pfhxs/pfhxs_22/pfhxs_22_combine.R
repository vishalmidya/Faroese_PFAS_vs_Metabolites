...
d8 <- fread("/sc/arion/projects/Faroese/pfas_met/c18/pfhxs/pfhxs_22/minerva_data_pfhxs_22_metabolites_28/pfhxs_22_met_28_hypothetical_test_stat_c18.txt") %>% select(all_of(c18_resultsid))

test_stat_table <- as.data.frame(cbind(d4, d8))


p4 <- fread("/sc/arion/projects/Faroese/pfas_met/hilic/pfhxs/pfhxs_22/minerva_data_pfhxs_22_metabolites_28/pfhxs_22_met_28_beta_fisher_hilic.txt")%>% filter(Met_id %in% hilic_metid)

p8 <- fread("/sc/arion/projects/Faroese/pfas_met/c18/pfhxs/pfhxs_22/minerva_data_pfhxs_22_metabolites_28/pfhxs_22_met_28_beta_fisher_c18.txt") %>% filter(Met_id %in% c18_metid)
...
write.table(hyp_p_val,"/sc/arion/projects/Faroese/pfas_met/combined_pvalues/randomized_adj_pvalues/pfhxs/pfhxs_22/pfhxs_22_hypothetical_pval.txt", row.names = FALSE)
...
write.table(p4,"/sc/arion/projects/Faroese/pfas_met/hilic/pfhxs/pfhxs_22/minerva_data_pfhxs_22_metabolites_28/pfhxs_22_met_28_beta_fisher_hilic.txt", row.names = FALSE)

write.table(p8,"/sc/arion/projects/Faroese/pfas_met/c18/pfhxs/pfhxs_22/minerva_data_pfhxs_22_metabolites_28/pfhxs_22_met_28_beta_fisher_c18.txt", row.names = FALSE)
