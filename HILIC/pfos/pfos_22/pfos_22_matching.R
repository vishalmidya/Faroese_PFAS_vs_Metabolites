...
sex + mage + mbmi  + smokepreg_2 + cmatfishpreg  + cparity + age22
...
m.out1.pfos22_age22 <- matchit(cpfos22 ~  sex + mage  + smokepreg_2 + cmatfishpreg  + cparity + age22, 
...
m.out1.pfos22_age28 <- matchit(cpfos22 ~  sex + mage  + smokepreg_2 + cmatfishpreg  + cparity + age28, 
...
write.csv(m.out1.pfos22_age22.matched, "C:/Users/yaom03/OneDrive - The Mount Sinai Hospital/New_faroese/HILIC/pfos/pfos_22/minerva_data_pfos_22_metabolites_22/matched_data_pfos_at_22_met_at_22.csv",
          row.names = F)


m.out1.pfos22_age28.matched <- match.data(m.out1.pfos22_age28)
write.csv(m.out1.pfos22_age28.matched, "C:/Users/yaom03/OneDrive - The Mount Sinai Hospital/New_faroese/HILIC/pfos/pfos_22/minerva_data_pfos_22_metabolites_28/matched_data_pfos_at_22_met_at_28.csv",
          row.names = F)
