...
m.out1.pfos_22_age22.matched <- read.csv("/sc/arion/projects/Faroese/hilic/pfos/pfos_22/minerva_data_pfos_22_metabolites_22/matched_data_pfos_at_22_met_at_22.csv")
...
write.table(test_stat_table,"/sc/arion/projects/Faroese/hilic/pfos/pfos_22/minerva_data_pfos_22_metabolites_22/pfos_22_met_22_hypothetical_test_stat_hilic.txt", row.names = FALSE)
...
write.table(data.pfos_22.met_at_22,"/sc/arion/projects/Faroese/hilic/pfos/pfos_22/minerva_data_pfos_22_metabolites_22/pfos_22_met_22_beta_fisher_hilic.txt", row.names = FALSE)
