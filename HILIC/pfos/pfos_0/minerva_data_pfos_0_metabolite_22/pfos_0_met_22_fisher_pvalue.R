...
write.table(data.pfos.0.met_at_22,"/sc/arion/work/yaom03/new_faroese/hilic/pfos/pfos_0/minerva_data_pfos_0_metabolites_22/pfos_0_met_22_beta_fisher.txt", row.names = FALSE)
