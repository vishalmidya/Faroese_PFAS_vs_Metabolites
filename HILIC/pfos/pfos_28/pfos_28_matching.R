...
write.csv(m.out1.pfos28_age28.matched, "C:/Users/midyav01/OneDrive - The Mount Sinai Hospital/MSSM Projects/METABOLOMICS/New_faroese/HILIC/pfos/pfos_28/minerva_data_pfos_28_metabolite_28/matched_data_pfos_at_28_met_at_28.csv",
          row.names = F)
