...
## matching
#---------------------------  at age 22
m.out1.pfoa22_age22 <- matchit(cpfoa22 ~ sex  + smokepreg_2 + cmatfishpreg  + cparity + age22, 
...
#---------------------------  at age 28
m.out1.pfoa22_age28 <- matchit(cpfoa22 ~ sex  + smokepreg_2 + cmatfishpreg  + cparity, 
...
write.csv(m.out1.pfoa22_age22.matched, "C:/Users/yaom03/OneDrive - The Mount Sinai Hospital/New_faroese/HILIC/pfoa/pfoa_22/minerva_data_pfoa_22_metabolites_22/matched_data_pfoa_at_22_met_at_22.csv",
          row.names = F)

m.out1.pfoa22_age28.matched <- match.data(m.out1.pfoa22_age28)
write.csv(m.out1.pfoa22_age28.matched, "C:/Users/yaom03/OneDrive - The Mount Sinai Hospital/New_faroese/HILIC/pfoa/pfoa_22/minerva_data_pfoa_22_metabolites_28/matched_data_pfoa_at_22_met_at_28.csv",
          row.names = F)
