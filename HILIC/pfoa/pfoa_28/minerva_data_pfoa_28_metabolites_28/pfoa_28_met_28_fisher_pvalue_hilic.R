...
m.out1.pfoa_28_age28.matched <- read.csv("/sc/arion/projects/Faroese/hilic/pfoa/pfoa_28/minerva_data_pfoa_28_metabolites_28/matched_data_pfoa_at_28_met_at_28.csv")
...
write.table(test_stat_table,"/sc/arion/projects/Faroese/hilic/pfoa/pfoa_28/minerva_data_pfoa_28_metabolites_28/pfoa_28_met_28_hypothetical_test_stat_hilic.txt", row.names = FALSE)
...
write.table(data.pfoa_28.met_at_28,"/sc/arion/projects/Faroese/hilic/pfoa/pfoa_28/minerva_data_pfoa_28_metabolites_28/pfoa_28_met_28_beta_fisher_hilic.txt", row.names = FALSE)
