...
## matching
#---------------------------  at age 28
m.out1.pfoa28_age28 <- matchit(cpfoa28 ~ sex  + smokepreg_2 + cmatfishpreg  + cparity, 
...
write.csv(m.out1.pfoa28_age28.matched, "C:/Users/yaom03/OneDrive - The Mount Sinai Hospital/New_faroese/HILIC/pfoa/pfoa_28/minerva_data_pfoa_28_metabolites_28/matched_data_pfoa_at_28_met_at_28.csv",
          row.names = F)
