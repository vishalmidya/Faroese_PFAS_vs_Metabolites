...
m.out1.pfhxs_0_age7.matched <- read.csv("/sc/arion/projects/Faroese/pfas_met/hilic/pfhxs/pfhxs_0/minerva_data_pfhxs_0_metabolites_7/matched_data_pfhxs_at_0_met_at_7.csv")

data = m.out1.pfhxs_0_age7.matched[,c(paste0("Met",seq(1:nrow(data_hilic))), 'cpfhxs0', 'sex',
...
write.table(test_stat_table,"/sc/arion/projects/Faroese/pfas_met/hilic/pfhxs/pfhxs_0/minerva_data_pfhxs_0_metabolites_7/pfhxs_0_met_7_hypothetical_test_stat_hilic.txt", row.names = FALSE)
...
write.table(data.pfhxs_0.met_at_7,"/sc/arion/projects/Faroese/pfas_met/hilic/pfhxs/pfhxs_0/minerva_data_pfhxs_0_metabolites_7/pfhxs_0_met_7_beta_fisher_hilic.txt", row.names = FALSE)
