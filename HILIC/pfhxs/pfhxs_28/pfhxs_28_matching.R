...
## matching
#---------------------------  at age 28
m.out1.pfhxs28_age28 <- matchit(cpfhxs28 ~ sex + mage  + smokepreg_2 + cmatfishpreg  + cparity, 
...
## export matched data
m.out1.pfhxs28_age28.matched <- match.data(m.out1.pfhxs28_age28)
write.csv(m.out1.pfhxs28_age28.matched, "C:/Users/yaom03/OneDrive - The Mount Sinai Hospital/New_faroese/HILIC/pfhxs/pfhxs_28/minerva_data_pfhxs_28_metabolites_28/matched_data_pfhxs_at_28_met_at_28.csv",
          row.names = F)
