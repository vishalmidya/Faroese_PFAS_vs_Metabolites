...
## matching
#---------------------------  at age 7
m.out1.pfhxs7_age7 <- matchit(cpfhxs7 ~  sex + mage  + smokepreg_2 + cmatfishpreg  + cparity +age7, 
...
#---------------------------  at age 14
m.out1.pfhxs7_age14 <- matchit(cpfhxs7 ~  sex + mage + mbmi  + smokepreg_2 + cmatfishpreg  + cparity  + age14,
...
#---------------------------  at age 22
m.out1.pfhxs7_age22 <- matchit(cpfhxs7 ~   mbmi  + smokepreg_2 + cmatfishpreg  + cparity  + age22, 
