...
m.out1.pfhxs_14_age14.matched <- read.csv("/sc/arion/projects/Faroese/hilic/pfhxs/pfhxs_14/minerva_data_pfhxs_14_metabolites_14/matched_data_pfhxs_at_14_met_at_14.csv")
...
write.table(test_stat_table,"/sc/arion/projects/Faroese/hilic/pfhxs/pfhxs_14/minerva_data_pfhxs_14_metabolites_14/pfhxs_14_met_14_hypothetical_test_stat_hilic.txt", row.names = FALSE)
...
write.table(data.pfhxs_14.met_at_14,"/sc/arion/projects/Faroese/hilic/pfhxs/pfhxs_14/minerva_data_pfhxs_14_metabolites_14/pfhxs_14_met_14_beta_fisher_hilic.txt", row.names = FALSE)
