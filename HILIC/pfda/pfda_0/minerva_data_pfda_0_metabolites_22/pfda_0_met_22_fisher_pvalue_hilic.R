...
m.out1.pfda_0_age22.matched <- read.csv("/sc/arion/projects/Faroese/hilic/pfda/pfda_0/minerva_data_pfda_0_metabolites_22/matched_data_pfda_at_0_met_at_22.csv")
...
write.table(test_stat_table,"/sc/arion/projects/Faroese/hilic/pfda/pfda_0/minerva_data_pfda_0_metabolites_22/pfda_0_met_22_hypothetical_test_stat_hilic.txt", row.names = FALSE)
...
write.table(data.pfda_0.met_at_22,"/sc/arion/projects/Faroese/hilic/pfda/pfda_0/minerva_data_pfda_0_metabolites_22/pfda_0_met_22_beta_fisher_hilic.txt", row.names = FALSE)
