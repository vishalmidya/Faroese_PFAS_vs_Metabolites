...
m.out1.pfda_22_age28.matched <- read.csv("/sc/arion/projects/Faroese/hilic/pfda/pfda_22/minerva_data_pfda_22_metabolites_28/matched_data_pfda_at_22_met_at_28.csv")
...
write.table(test_stat_table,"/sc/arion/projects/Faroese/hilic/pfda/pfda_22/minerva_data_pfda_22_metabolites_28/pfda_22_met_28_hypothetical_test_stat_hilic.txt", row.names = FALSE)
...
write.table(data.pfda_22.met_at_28,"/sc/arion/projects/Faroese/hilic/pfda/pfda_22/minerva_data_pfda_22_metabolites_28/pfda_22_met_28_beta_fisher_hilic.txt", row.names = FALSE)
