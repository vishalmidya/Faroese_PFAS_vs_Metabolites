...
## matching
#---------------------------  at age 28
m.out1.pfda28_age28 <- matchit(cpfda28 ~ sex + mage + mbmi  + smokepreg_2 + cmatfishpreg  + cparity + age28, 
...
write.csv(m.out1.pfda28_age28.matched, "C:/Users/yaom03/OneDrive - The Mount Sinai Hospital/New_faroese/HILIC/pfda/pfda_28/minerva_data_pfda_28_metabolites_28/matched_data_pfda_at_28_met_at_28.csv",
          row.names = F)
