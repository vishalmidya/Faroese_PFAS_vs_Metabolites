...
#---------------------------  at age 22
m.out1.pfna14_age22 <- matchit(cpfna14 ~  sex  + smokepreg_2 + cmatfishpreg  + cparity + age22, 
...
#---------------------------  at age 28
m.out1.pfna14_age28 <- matchit(cpfna14 ~ sex + cmatfishpreg  + cparity + age28, 
...
write.csv(m.out1.pfna14_age14.matched, "C:/Users/yaom03/OneDrive - The Mount Sinai Hospital/New_faroese/HILIC/pfna/pfna_14/minerva_data_pfna_14_metabolites_14/matched_data_pfna_at_14_met_at_14.csv",
          row.names = F)

m.out1.pfna14_age22.matched <- match.data(m.out1.pfna14_age22)
write.csv(m.out1.pfna14_age22.matched, "C:/Users/yaom03/OneDrive - The Mount Sinai Hospital/New_faroese/HILIC/pfna/pfna_14/minerva_data_pfna_14_metabolites_22/matched_data_pfna_at_14_met_at_22.csv",
          row.names = F)

m.out1.pfna14_age28.matched <- match.data(m.out1.pfna14_age28)
write.csv(m.out1.pfna14_age28.matched, "C:/Users/yaom03/OneDrive - The Mount Sinai Hospital/New_faroese/HILIC/pfna/pfna_14/minerva_data_pfna_14_metabolites_28/matched_data_pfna_at_14_met_at_28.csv",
          row.names = F)
