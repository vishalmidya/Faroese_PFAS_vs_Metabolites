...
write.csv(m.out1.pfna28_age28.matched, "C:/Users/yaom03/OneDrive - The Mount Sinai Hospital/New_faroese/HILIC/pfna/pfna_28/minerva_data_pfna_28_metabolite_28/matched_data_pfna_at_28_met_at_28.csv",
          row.names = F)
