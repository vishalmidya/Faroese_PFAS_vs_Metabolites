...
## matching
#---------------------------  at age 7
m.out1.pfna0_age7 <- matchit(cpfna0 ~  sex + mage + mbmi  + smokepreg_2 + cmatfishpreg  + cparity, 
...
#---------------------------  at age 14
m.out1.pfna0_age14 <- matchit(cpfna0 ~   sex + mage  + smokepreg_2 + cmatfishpreg  + cparity + age14,
...
#---------------------------  at age 22
m.out1.pfna0_age22 <- matchit(cpfna0 ~   sex + mbmi  + smokepreg_2 + cmatfishpreg  + cparity + age22, 
...
#---------------------------  at age 28
m.out1.pfna0_age28 <- matchit(cpfna0 ~ sex + mage + mbmi  + smokepreg_2 + cmatfishpreg  + cparity + age28, 
...
write.csv(m.out1.pfna0_age7.matched, "C:/Users/yaom03/OneDrive - The Mount Sinai Hospital/New_faroese/HILIC/pfna/pfna_0/minerva_data_pfna_0_metabolites_7/matched_data_pfna_at_0_met_at_7.csv",
          row.names = F)

m.out1.pfna0_age14.matched <- match.data(m.out1.pfna0_age14)
write.csv(m.out1.pfna0_age14.matched, "C:/Users/yaom03/OneDrive - The Mount Sinai Hospital/New_faroese/HILIC/pfna/pfna_0/minerva_data_pfna_0_metabolites_14/matched_data_pfna_at_0_met_at_14.csv",
          row.names = F)

m.out1.pfna0_age22.matched <- match.data(m.out1.pfna0_age22)
write.csv(m.out1.pfna0_age22.matched, "C:/Users/yaom03/OneDrive - The Mount Sinai Hospital/New_faroese/HILIC/pfna/pfna_0/minerva_data_pfna_0_metabolites_22/matched_data_pfna_at_0_met_at_22.csv",
          row.names = F)

m.out1.pfna0_age28.matched <- match.data(m.out1.pfna0_age28)
write.csv(m.out1.pfna0_age28.matched, "C:/Users/yaom03/OneDrive - The Mount Sinai Hospital/New_faroese/HILIC/pfna/pfna_0/minerva_data_pfna_0_metabolites_28/matched_data_pfna_at_0_met_at_28.csv",
          row.names = F)
