...
## matching
#---------------------------  at age 7
m.out1.pfna0_age7 <- matchit(cpfna0 ~  mage  + smokepreg_2 + cmatfishpreg, 
...
#---------------------------  at age 14
m.out1.pfna0_age14 <- matchit(cpfna0 ~   sex  + smokepreg_2 + cmatfishpreg  + cparity,
...
#---------------------------  at age 22
m.out1.pfna0_age22 <- matchit(cpfna0 ~   sex + cmatfishpreg  + cparity , 
