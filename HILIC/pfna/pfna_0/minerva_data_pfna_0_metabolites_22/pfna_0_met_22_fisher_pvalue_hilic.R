...
m.out1.pfna_0_age22.matched <- read.csv("/sc/arion/projects/Faroese/hilic/pfna/pfna_0/minerva_data_pfna_0_metabolites_22/matched_data_pfna_at_0_met_at_22.csv")
...
write.table(test_stat_table,"/sc/arion/projects/Faroese/hilic/pfna/pfna_0/minerva_data_pfna_0_metabolites_22/pfna_0_met_22_hypothetical_test_stat_hilic.txt", row.names = FALSE)
...
write.table(data.pfna_0.met_at_22,"/sc/arion/projects/Faroese/hilic/pfna/pfna_0/minerva_data_pfna_0_metabolites_22/pfna_0_met_22_beta_fisher_hilic.txt", row.names = FALSE)
