...
m.out1.pfna_7_age14.matched <- read.csv("/sc/arion/projects/Faroese/pfas_met/hilic/pfna/pfna_7/minerva_data_pfna_7_metabolites_14/matched_data_pfna_at_7_met_at_14.csv")

data = m.out1.pfna_7_age14.matched[,c(paste0("Met",seq(1:nrow(data_hilic))), 'cpfna7', 'sex',
...
write.table(test_stat_table,"/sc/arion/projects/Faroese/pfas_met/hilic/pfna/pfna_7/minerva_data_pfna_7_metabolites_14/pfna_7_met_14_hypothetical_test_stat_hilic.txt", row.names = FALSE)
...
write.table(data.pfna_7.met_at_14,"/sc/arion/projects/Faroese/pfas_met/hilic/pfna/pfna_7/minerva_data_pfna_7_metabolites_14/pfna_7_met_14_beta_fisher_hilic.txt", row.names = FALSE)
