...
m.out1.pfna_22_age28.matched <- read.csv("/sc/arion/projects/Faroese/pfas_met/hilic/pfna/pfna_22/minerva_data_pfna_22_metabolites_28/matched_data_pfna_at_22_met_at_28.csv")

data = m.out1.pfna_22_age28.matched[,c(paste0("Met",seq(1:nrow(data_hilic))), 'cpfna22', 'sex',
...
write.table(test_stat_table,"/sc/arion/projects/Faroese/pfas_met/hilic/pfna/pfna_22/minerva_data_pfna_22_metabolites_28/pfna_22_met_28_hypothetical_test_stat_hilic.txt", row.names = FALSE)
...
write.table(data.pfna_22.met_at_28,"/sc/arion/projects/Faroese/pfas_met/hilic/pfna/pfna_22/minerva_data_pfna_22_metabolites_28/pfna_22_met_28_beta_fisher_hilic.txt", row.names = FALSE)
