...
## matching
#---------------------------  at age 22
m.out1.pfna22_age22 <- matchit(cpfna22 ~ sex + mbmi  + smokepreg_2 + cmatfishpreg  + cparity, 
...
#---------------------------  at age 28
m.out1.pfna22_age28 <- matchit(cpfna22 ~ sex + mage + mbmi  + smokepreg_2 + cmatfishpreg  + cparity + age28, 
...
write.csv(m.out1.pfna22_age22.matched, "C:/Users/yaom03/OneDrive - The Mount Sinai Hospital/New_faroese/HILIC/pfna/pfna_22/minerva_data_pfna_22_metabolites_22/matched_data_pfna_at_22_met_at_22.csv",
          row.names = F)

m.out1.pfna22_age28.matched <- match.data(m.out1.pfna22_age28)
write.csv(m.out1.pfna22_age28.matched, "C:/Users/yaom03/OneDrive - The Mount Sinai Hospital/New_faroese/HILIC/pfna/pfna_22/minerva_data_pfna_22_metabolites_28/matched_data_pfna_at_22_met_at_28.csv",
          row.names = F)
