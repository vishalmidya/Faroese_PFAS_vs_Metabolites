...
#### 2.
data<- read.csv("/sc/arion/projects/Faroese/pfas_met_125/pfas_met/hilic/pfos/pfos_0/minerva_data_pfos_0_metabolites_14/matched_data_pfos_at_0_met_at_14.csv", check.names = F)
...
#### 3.
data<- read.csv("/sc/arion/projects/Faroese/pfas_met_125/pfas_met/c18/pfna/pfna_0/minerva_data_pfna_0_metabolites_22/matched_data_pfna_at_0_met_at_22.csv", check.names = F)
...
#### 4.
data<- read.csv("/sc/arion/projects/Faroese/pfas_met_125/pfas_met/hilic/pfna/pfna_7/minerva_data_pfna_7_metabolites_28/matched_data_pfna_at_7_met_at_28.csv", check.names = F)
...
#### 5.
data<- read.csv("/sc/arion/projects/Faroese/pfas_met_125/pfas_met/hilic/pfos/pfos_7/minerva_data_pfos_7_metabolites_28/matched_data_pfos_at_7_met_at_28.csv", check.names = F)
...
#### 7.
data<- read.csv("/sc/arion/projects/Faroese/pfas_met_125/pfas_met/hilic/pfhxs/pfhxs_14/minerva_data_pfhxs_14_metabolites_22/matched_data_pfhxs_at_14_met_at_22.csv", check.names = F)
...
#### 9.
data<- read.csv("/sc/arion/projects/Faroese/pfas_met_125/pfas_met/c18/pfhxs/pfhxs_22/minerva_data_pfhxs_22_metabolites_28/matched_data_pfhxs_at_22_met_at_28.csv", check.names = F)
...
write.table(std,"/sc/arion/projects/Faroese/pfas_met_125/pfas_met/check/std125_sig500.txt", row.names = FALSE)
