...
std<- data.frame(PFAS_age=rep(NA,22),
                 ...
                 Met_id=rep(NA,22),
                 Mode=rep(NA,22),
                 std.err.500=rep(NA, 22))


#### 1.
data<- read.csv("C:/Users/yaom03/OneDrive - The Mount Sinai Hospital/New_faroese/HILIC/pfoa/pfoa_0/minerva_data_pfoa_0_metabolites_7/matched_data_pfoa_at_0_met_at_7.csv", check.names = F)
...
#### 3.
data<- read.csv("C:/Users/yaom03/OneDrive - The Mount Sinai Hospital/New_faroese/HILIC/pfhxs/pfhxs_0/minerva_data_pfhxs_0_metabolites_14/matched_data_pfhxs_at_0_met_at_14.csv", check.names = F)
...
#### 4.
data<- read.csv("C:/Users/yaom03/OneDrive - The Mount Sinai Hospital/New_faroese/C18/pfda/pfda_0/minerva_data_pfda_0_metabolites_14/matched_data_pfda_at_0_met_at_14.csv", check.names = F)
...
#### 5.
data<- read.csv("C:/Users/yaom03/OneDrive - The Mount Sinai Hospital/New_faroese/C18/pfna/pfna_0/minerva_data_pfna_0_metabolites_14/matched_data_pfna_at_0_met_at_14.csv", check.names = F)
...
#### 6.
data<- read.csv("C:/Users/yaom03/OneDrive - The Mount Sinai Hospital/New_faroese/HILIC/pfhxs/pfhxs_7/minerva_data_pfhxs_7_metabolites_22/matched_data_pfhxs_at_7_met_at_22.csv", check.names = F)
...
#### 7.
data<- read.csv("C:/Users/yaom03/OneDrive - The Mount Sinai Hospital/New_faroese/C18/pfhxs/pfhxs_7/minerva_data_pfhxs_7_metabolites_22/matched_data_pfhxs_at_7_met_at_22.csv", check.names = F)
...
#### 8.
data<- read.csv("C:/Users/yaom03/OneDrive - The Mount Sinai Hospital/New_faroese/HILIC/pfoa/pfoa_14/minerva_data_pfoa_14_metabolites_22/matched_data_pfoa_at_14_met_at_22.csv", check.names = F)
...
#### 9.
data<- read.csv("C:/Users/yaom03/OneDrive - The Mount Sinai Hospital/New_faroese/C18/pfna/pfna_14/minerva_data_pfna_14_metabolites_22/matched_data_pfna_at_14_met_at_22.csv", check.names = F)
...
#### 10.
data<- read.csv("C:/Users/yaom03/OneDrive - The Mount Sinai Hospital/New_faroese/HILIC/pfhxs/pfhxs_14/minerva_data_pfhxs_14_metabolites_28/matched_data_pfhxs_at_14_met_at_28.csv", check.names = F)
...
#### 12.
data<- read.csv("C:/Users/yaom03/OneDrive - The Mount Sinai Hospital/New_faroese/HILIC/pfda/pfda_14/minerva_data_pfda_14_metabolites_28/matched_data_pfda_at_14_met_at_28.csv", check.names = F)
...
#### 13.
data<- read.csv("C:/Users/yaom03/OneDrive - The Mount Sinai Hospital/New_faroese/C18/pfna/pfna_14/minerva_data_pfna_14_metabolites_28/matched_data_pfna_at_14_met_at_28.csv", check.names = F)
...
#### 16.
data<- read.csv("C:/Users/yaom03/OneDrive - The Mount Sinai Hospital/New_faroese/HILIC/pfos/pfos_22/minerva_data_pfos_22_metabolites_28/matched_data_pfos_at_22_met_at_28.csv", check.names = F)
...
#### 17.
data<- read.csv("C:/Users/yaom03/OneDrive - The Mount Sinai Hospital/New_faroese/HILIC/pfoa/pfoa_22/minerva_data_pfoa_22_metabolites_28/matched_data_pfoa_at_22_met_at_28.csv", check.names = F)
...
#### 21.
data<- read.csv("C:/Users/yaom03/OneDrive - The Mount Sinai Hospital/New_faroese/C18/pfos/pfos_22/minerva_data_pfos_22_metabolites_28/matched_data_pfos_at_22_met_at_28.csv", check.names = F)
...
#### 22.
data<- read.csv("C:/Users/yaom03/OneDrive - The Mount Sinai Hospital/New_faroese/C18/pfoa/pfoa_22/minerva_data_pfoa_22_metabolites_28/matched_data_pfoa_at_22_met_at_28.csv", check.names = F)
...
write.table(std,"~/Projects/Faroese_Minerva/check/std500_sig125.txt", row.names = FALSE)
