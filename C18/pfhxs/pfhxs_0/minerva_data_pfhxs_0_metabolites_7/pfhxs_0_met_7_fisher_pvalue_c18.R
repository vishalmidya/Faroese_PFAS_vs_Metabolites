...
m.out1.pfhxs_0_age7.matched <- read.csv("/sc/arion/projects/Faroese/pfas_met/c18/pfhxs/pfhxs_0/minerva_data_pfhxs_0_metabolites_7/matched_data_pfhxs_at_0_met_at_7.csv")
...
data.pfhxs_0.met_at_7 <- cbind(data_c18[,c("mz","time","Met_id")])
...
write.table(test_stat_table,"/sc/arion/projects/Faroese/pfas_met/c18/pfhxs/pfhxs_0/minerva_data_pfhxs_0_metabolites_7/pfhxs_0_met_7_hypothetical_test_stat_c18.txt", row.names = FALSE)
...
write.table(data.pfhxs_0.met_at_7,"/sc/arion/projects/Faroese/pfas_met/c18/pfhxs/pfhxs_0/minerva_data_pfhxs_0_metabolites_7/pfhxs_0_met_7_beta_fisher_c18.txt", row.names = FALSE)
