...
write.csv(m.out1.pfhxs7_age7.matched, "C:/Users/yaom03/OneDrive - The Mount Sinai Hospital/New_faroese/C18/pfhxs/pfhxs_7/minerva_data_pfhxs_7_metabolites_7/matched_data_pfhxs_at_7_met_at_7.csv",
          row.names = F)

m.out1.pfhxs7_age14.matched <- match.data(m.out1.pfhxs7_age14)
write.csv(m.out1.pfhxs7_age14.matched, "C:/Users/yaom03/OneDrive - The Mount Sinai Hospital/New_faroese/C18/pfhxs/pfhxs_7/minerva_data_pfhxs_7_metabolites_14/matched_data_pfhxs_at_7_met_at_14.csv",
          row.names = F)

m.out1.pfhxs7_age22.matched <- match.data(m.out1.pfhxs7_age22)
write.csv(m.out1.pfhxs7_age22.matched, "C:/Users/yaom03/OneDrive - The Mount Sinai Hospital/New_faroese/C18/pfhxs/pfhxs_7/minerva_data_pfhxs_7_metabolites_22/matched_data_pfhxs_at_7_met_at_22.csv",
          row.names = F)

m.out1.pfhxs7_age28.matched <- match.data(m.out1.pfhxs7_age28)
write.csv(m.out1.pfhxs7_age28.matched, "C:/Users/yaom03/OneDrive - The Mount Sinai Hospital/New_faroese/C18/pfhxs/pfhxs_7/minerva_data_pfhxs_7_metabolites_28/matched_data_pfhxs_at_7_met_at_28.csv",
          row.names = F)
