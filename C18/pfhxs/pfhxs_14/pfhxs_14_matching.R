...
write.csv(m.out1.pfhxs14_age14.matched, "C:/Users/yaom03/OneDrive - The Mount Sinai Hospital/New_faroese/C18/pfhxs/pfhxs_14/minerva_data_pfhxs_14_metabolite_14/matched_data_pfhxs_at_14_met_at_14.csv",
          row.names = F)

m.out1.pfhxs14_age22.matched <- match.data(m.out1.pfhxs14_age22)
write.csv(m.out1.pfhxs14_age22.matched, "C:/Users/yaom03/OneDrive - The Mount Sinai Hospital/New_faroese/C18/pfhxs/pfhxs_14/minerva_data_pfhxs_14_metabolite_22/matched_data_pfhxs_at_14_met_at_22.csv",
          row.names = F)

m.out1.pfhxs14_age28.matched <- match.data(m.out1.pfhxs14_age28)
write.csv(m.out1.pfhxs14_age28.matched, "C:/Users/yaom03/OneDrive - The Mount Sinai Hospital/New_faroese/C18/pfhxs/pfhxs_14/minerva_data_pfhxs_14_metabolite_28/matched_data_pfhxs_at_14_met_at_28.csv",
          row.names = F)
