...
m.out1.pfda_22_age28.matched <- read.csv("/sc/arion/projects/Faroese/pfas_met/c18/pfda/pfda_22/minerva_data_pfda_22_metabolites_28/matched_data_pfda_at_22_met_at_28.csv")

data = m.out1.pfda_22_age28.matched[,c(paste0("Met",seq(1:nrow(data_c18))), 'cpfda22', 'sex',
...
write.table(test_stat_table,"/sc/arion/projects/Faroese/pfas_met/c18/pfda/pfda_22/minerva_data_pfda_22_metabolites_28/pfda_22_met_28_hypothetical_test_stat_c18.txt", row.names = FALSE)
...
write.table(data.pfda_22.met_at_28,"/sc/arion/projects/Faroese/pfas_met/c18/pfda/pfda_22/minerva_data_pfda_22_metabolites_28/pfda_22_met_28_beta_fisher_c18.txt", row.names = FALSE)
