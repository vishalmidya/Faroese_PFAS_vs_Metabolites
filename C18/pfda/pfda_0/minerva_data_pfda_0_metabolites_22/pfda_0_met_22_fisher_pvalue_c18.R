...
m.out1.pfda_0_age22.matched <- read.csv("/sc/arion/projects/Faroese/pfas_met/c18/pfda/pfda_0/minerva_data_pfda_0_metabolites_22/matched_data_pfda_at_0_met_at_22.csv")

data = m.out1.pfda_0_age22.matched[,c(paste0("Met",seq(1:nrow(data_c18))), 'cpfda0', 'sex',
...
write.table(test_stat_table,"/sc/arion/projects/Faroese/pfas_met/c18/pfda/pfda_0/minerva_data_pfda_0_metabolites_22/pfda_0_met_22_hypothetical_test_stat_c18.txt", row.names = FALSE)
...
write.table(data.pfda_0.met_at_22,"/sc/arion/projects/Faroese/pfas_met/c18/pfda/pfda_0/minerva_data_pfda_0_metabolites_22/pfda_0_met_22_beta_fisher_c18.txt", row.names = FALSE)
