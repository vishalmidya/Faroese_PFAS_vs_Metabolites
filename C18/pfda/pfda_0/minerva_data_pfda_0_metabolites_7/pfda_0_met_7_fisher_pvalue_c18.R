...
data = m.out1.pfda_0_age7.matched[,c(paste0("Met",seq(1:nrow(data_c18))), 'cpfda_0', 'sex',
                                    'mage',  'mbmi', 'smokepreg_2', 'cmatfishpreg', 'cparity', 'age7' )]

data.pfda_0.met_at_7 <- cbind(data_c18[,c("mz","time","KEGG","Annotation.confidence.score","chem_name","Met_id")])
...
write.table(test_stat_table,"/sc/arion/work/yaom03/new_faroese/c18/pfda/pfda_0/minerva_data_pfda_0_metabolites_7/pfda_0_met_7_hypothetical_test_stat_c18.txt", row.names = FALSE)
...
write.table(data.pfda_0.met_at_7,"/sc/arion/work/yaom03/new_faroese/c18/pfda/pfda_0/minerva_data_pfda_0_metabolites_7/pfda_0_met_7_beta_fisher_c18.txt", row.names = FALSE)
