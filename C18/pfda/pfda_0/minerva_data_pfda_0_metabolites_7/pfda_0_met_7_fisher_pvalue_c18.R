...
write.table(test_stat_table,"/sc/arion/projects/Faroese/pfas_met/c18/pfda/pfda_0/minerva_data_pfda_0_metabolites_7/pfda_0_met_7_hypothetical_test_stat_c18.txt", row.names = FALSE)
...
write.table(data.pfda_0.met_at_7,"/sc/arion/projects/Faroese/pfas_met/c18/pfda/pfda_0/minerva_data_pfda_0_metabolites_7/pfda_0_met_7_beta_fisher_c18.txt", row.names = FALSE)
