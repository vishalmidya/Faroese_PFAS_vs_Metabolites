...
data = m.out1.pfda_0_age28.matched[,c(paste0("Met",seq(1:nrow(data_c18))), 'cpfda_0', 'sex',
                                    'mage',  'mbmi', 'smokepreg_2', 'cmatfishpreg', 'cparity', 'age28' )]

data.pfda_0.met_at_28 <- cbind(data_c18[,c("mz","time","KEGG","Annotation.confidence.score","chem_name","Met_id")])
