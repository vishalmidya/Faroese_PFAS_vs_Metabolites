...
m.out1.pfos0_age28.matched <- read.csv("/sc/arion/work/yaom03/new_faroese/c18/pfos/pfos_0/minerva_data_pfos_0_metabolites_28/matched_data_pfos_at_0_met_at_28.csv")
...
write.table(test_stat_table,"/sc/arion/work/yaom03/new_faroese/c18/pfos/pfos_0/minerva_data_pfos_0_metabolites_28/pfos_0_met_28_hypothetical_test_stat_c18.txt", row.names = FALSE)
...
write.table(data.pfos.0.met_at_28,"/sc/arion/work/yaom03/new_faroese/c18/pfos/pfos_0/minerva_data_pfos_0_metabolites_28/pfos_0_met_28_beta_fisher_c18.txt", row.names = FALSE)
