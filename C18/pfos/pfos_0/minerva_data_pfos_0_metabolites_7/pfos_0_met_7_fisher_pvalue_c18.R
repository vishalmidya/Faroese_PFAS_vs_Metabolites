...
m.out1.pfos0_age7.matched <- read.csv("/sc/arion/projects/Faroese/c18/pfos/pfos_0/minerva_data_pfos_0_metabolites_7/matched_data_pfos_at_0_met_at_7.csv")

data = m.out1.pfos0_age7.matched[,c(paste0("Met",seq(1:nrow(data_c18))), 'cpfos0', 'sex',
                                    'mage',  'mbmi', 'smokepreg_2', 'cmatfishpreg', 'cparity', 'age7' )]

data.pfos.0.met_at_7 <- cbind(data_c18[,c("mz","time","KEGG","Annotation.confidence.score","chem_name","Met_id")])
...
write.table(test_stat_table,"/sc/arion/projects/Faroese/c18/pfos/pfos_0/minerva_data_pfos_0_metabolites_7/pfos_0_met_7_hypothetical_test_stat_c18.txt", row.names = FALSE)
...
write.table(data.pfos.0.met_at_7,"/sc/arion/projects/Faroese/c18/pfos/pfos_0/minerva_data_pfos_0_metabolites_7/pfos_0_met_7_beta_fisher_c18.txt", row.names = FALSE)
