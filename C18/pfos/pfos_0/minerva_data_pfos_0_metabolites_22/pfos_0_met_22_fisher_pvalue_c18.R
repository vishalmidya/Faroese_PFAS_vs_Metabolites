...
m.out1.pfos0_age22.matched <- read.csv("/sc/arion/projects/Faroese/pfas_met/c18/pfos/pfos_0/minerva_data_pfos_0_metabolites_22/matched_data_pfos_at_0_met_at_22.csv")
...
write.table(test_stat_table,"/sc/arion/projects/Faroese/pfas_met/c18/pfos/pfos_0/minerva_data_pfos_0_metabolites_22/pfos_0_met_22_hypothetical_test_stat_c18.txt", row.names = FALSE)
...
write.table(data.pfos.0.met_at_22,"/sc/arion/projects/Faroese/pfas_met/c18/pfos/pfos_0/minerva_data_pfos_0_metabolites_22/pfos_0_met_22_beta_fisher_c18.txt", row.names = FALSE)
