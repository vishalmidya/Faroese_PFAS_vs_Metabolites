...
module load R/4.1.0
Rscript pfos_0_met_7_fisher_pvalue.R


#### old

cd /
cd /sc/arion/work/yaom03/new_faroese/hilic/pfos/pfos_0/minerva_data_pfos_0_metabolites_7
bsub -J pfos_0_met_7 -P acc_damasv01a  -q premium  -n 3 -R rusage[mem=5G] -R span[ptile=3] -W 1:00 -o %J.stdout -eo %J.stderr -L /bin/bash
