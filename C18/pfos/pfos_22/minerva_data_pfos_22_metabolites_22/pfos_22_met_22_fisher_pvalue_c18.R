...
m.out1.pfos_22_age22.matched <- read.csv("/sc/arion/projects/Faroese/pfas_met/c18/pfos/pfos_22/minerva_data_pfos_22_metabolites_22/matched_data_pfos_at_22_met_at_22.csv")

data = m.out1.pfos_22_age22.matched[,c(paste0("Met",seq(1:nrow(data_c18))), 'cpfos22', 'sex',
...
write.table(test_stat_table,"/sc/arion/projects/Faroese/pfas_met/c18/pfos/pfos_22/minerva_data_pfos_22_metabolites_22/pfos_22_met_22_hypothetical_test_stat_c18.txt", row.names = FALSE)
...
write.table(data.pfos_22.met_at_22,"/sc/arion/projects/Faroese/pfas_met/c18/pfos/pfos_22/minerva_data_pfos_22_metabolites_22/pfos_22_met_22_beta_fisher_c18.txt", row.names = FALSE)
