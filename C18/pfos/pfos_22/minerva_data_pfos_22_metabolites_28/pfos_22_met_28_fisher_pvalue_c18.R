...
m.out1.pfos_22_age28.matched <- read.csv("/sc/arion/projects/Faroese/pfas_met/c18/pfos/pfos_22/minerva_data_pfos_22_metabolites_28/matched_data_pfos_at_22_met_at_28.csv")
...
data.pfos_22.met_at_28 <- cbind(data_c18[,c("mz","time","Met_id")])
...
write.table(test_stat_table,"/sc/arion/projects/Faroese/pfas_met/c18/pfos/pfos_22/minerva_data_pfos_22_metabolites_28/pfos_22_met_28_hypothetical_test_stat_c18.txt", row.names = FALSE)
...
write.table(data.pfos_22.met_at_28,"/sc/arion/projects/Faroese/pfas_met/c18/pfos/pfos_22/minerva_data_pfos_22_metabolites_28/pfos_22_met_28_beta_fisher_c18.txt", row.names = FALSE)
