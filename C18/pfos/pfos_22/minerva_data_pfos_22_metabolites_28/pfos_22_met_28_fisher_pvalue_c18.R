...
write.table(test_stat_table,"/sc/arion/work/yaom03/new_faroese/c18/pfos/pfos_22/minerva_data_pfos_22_metabolites_28/pfos_22_met_28_hypothetical_test_stat_c18.txt", row.names = FALSE)
...
write.table(data.pfos_22.met_at_28,"/sc/arion/work/yaom03/new_faroese/c18/pfos/pfos_22/minerva_data_pfos_22_metabolites_28/pfos_22_met_28_beta_fisher_c18.txt", row.names = FALSE)
