...
m.out1.pfoa_0_age7.matched <- read.csv("/sc/arion/projects/Faroese/pfas_met/c18/pfoa/pfoa_0/minerva_data_pfoa_0_metabolites_7/matched_data_pfoa_at_0_met_at_7.csv")

data = m.out1.pfoa_0_age7.matched[,c(paste0("Met",seq(1:nrow(data_c18))), 'cpfoa0', 'sex',
...
write.table(test_stat_table,"/sc/arion/projects/Faroese/pfas_met/c18/pfoa/pfoa_0/minerva_data_pfoa_0_metabolites_7/pfoa_0_met_7_hypothetical_test_stat_c18.txt", row.names = FALSE)
...
write.table(data.pfoa_0.met_at_7,"/sc/arion/projects/Faroese/pfas_met/c18/pfoa/pfoa_0/minerva_data_pfoa_0_metabolites_7/pfoa_0_met_7_beta_fisher_c18.txt", row.names = FALSE)
