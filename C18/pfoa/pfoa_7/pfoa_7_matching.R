...
## matching
#---------------------------  at age 7
m.out1.pfoa7_age7 <- matchit(cpfoa7 ~   sex  + smokepreg_2 + cmatfishpreg  + cparity, 
...
#---------------------------  at age 14
m.out1.pfoa7_age14 <- matchit(cpfoa7 ~  mage + mbmi  + smokepreg_2 + cmatfishpreg  + cparity + age14,
...
#---------------------------  at age 22
m.out1.pfoa7_age22 <- matchit(cpfoa7 ~ sex + mage + mbmi  + smokepreg_2  + cparity, 
...
#---------------------------  at age 28
m.out1.pfoa7_age28 <- matchit(cpfoa7 ~ sex + mage  + smokepreg_2 + cmatfishpreg  + cparity + age28, 
...
write.csv(m.out1.pfoa7_age7.matched, "C:/Users/yaom03/OneDrive - The Mount Sinai Hospital/New_faroese/C18/pfoa/pfoa_7/minerva_data_pfoa_7_metabolites_7/matched_data_pfoa_at_7_met_at_7.csv",
          row.names = F)

m.out1.pfoa7_age14.matched <- match.data(m.out1.pfoa7_age14)
write.csv(m.out1.pfoa7_age14.matched, "C:/Users/yaom03/OneDrive - The Mount Sinai Hospital/New_faroese/C18/pfoa/pfoa_7/minerva_data_pfoa_7_metabolites_14/matched_data_pfoa_at_7_met_at_14.csv",
          row.names = F)

m.out1.pfoa7_age22.matched <- match.data(m.out1.pfoa7_age22)
write.csv(m.out1.pfoa7_age22.matched, "C:/Users/yaom03/OneDrive - The Mount Sinai Hospital/New_faroese/C18/pfoa/pfoa_7/minerva_data_pfoa_7_metabolites_22/matched_data_pfoa_at_7_met_at_22.csv",
          row.names = F)

m.out1.pfoa7_age28.matched <- match.data(m.out1.pfoa7_age28)
write.csv(m.out1.pfoa7_age28.matched, "C:/Users/yaom03/OneDrive - The Mount Sinai Hospital/New_faroese/C18/pfoa/pfoa_7/minerva_data_pfoa_7_metabolites_28/matched_data_pfoa_at_7_met_at_28.csv",
          row.names = F)
